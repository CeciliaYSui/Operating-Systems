 .data
 	...
 	prompt: .asciiz " Enter a numeric grade (out of 100), 999 to exit data entry " 
        ...
        separater: .asciiz ", " 
        listA:    .asciiz "\nAs List (first 0 indicates no As): "
        listB:    .asciiz "\nBs List (first 0 indicates no Bs): "
        listC:    .asciiz "\nCs List (first 0 indicates no Cs): "
        listD:    .asciiz "\nDs List (first 0 indicates no Ds): "
        listF:    .asciiz "\nFs List (first 0 indicates no Fs): "
        A: .word 90 
        B: .word 80  
        C: .word 70
        D: .word 60
